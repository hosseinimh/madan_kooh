export const layout = { brand: "معدن کوه" };
...
export const permissions = {
    readAllWBs: "مشاهده همه باسکول‌ها",
    readWB1: "مشاهده باسکول 1",
    readWB2: "مشاهده باسکول 2",
    editFactorDescription: "ثبت شماره بارنامه",
    noPermissionsFound: "هیچ مجوزی یافت نشد.",
};

export const weightBridges = {
    allWbs: "همه باسکول‌ها",
    wb1: "باسکول 1",
    wb2: "باسکول 2",
};
...
export const footer = {
    text: "Copyright © معدن کوه",
    version: "داشبورد معدن کوه - نسخه: 1.0.0",
};

export const notAuthPages = {
    _title: "معدن کوه",
    _subTitle: "داشبورد معدن کوه",
};
...
export const loginUserPage = {
    ...
    _subTitle:
        "جهت استفاده از امکانات داشبورد معدن کوه وارد حساب کاربری خود شوید.",
    username: "نام کاربری",
...
export const usersPage = {
    ...
    nameFamilyPlaceholder: "نام و نام خانوادگی",
    mobile: "موبایل",
    roles: "‌سمت‌ها",
    permissions: "مجوزها",
    status: "وضعیت",
...
export const addUserPage = {
    ...
    user: "کاربر",
    permissions: "مجوزها",
    noPermissionsSelected: "هیچ مجوزی برای کاربر انتخاب نشده است.",
